 ...
 * Plugin URI:  https://jayj.dk/plugins/jayj-quicktag/
	...
	<form action="options.php" method="post">
		<?php
			...
			if ( isset( $_POST['jayj-quicktag-import-save'] ) ) :
				...
				$data = json_decode( stripslashes($_POST['jayj-quicktag-import'] ), true);
	...
	<form action="" method="post" name="jayj-quicktag-import" class="jayj-quicktag-postboxes">
		...
		<div class="postbox closed">
			...
			<div class="inside">
				...
				<textarea rows="10" cols="60" onclick="this.focus(); this.select();"><?php echo esc_textarea( json_encode( $options ) ); ?></textarea>
			</div>
		</div> <!-- .postbox -->
